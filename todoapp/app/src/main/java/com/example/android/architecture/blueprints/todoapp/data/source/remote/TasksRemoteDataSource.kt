...
import com.example.android.architecture.blueprints.todoapp.util.removeIf
...
object TasksRemoteDataSource : TasksDataSource {
  ...
  override fun getTasks(callback: TasksDataSource.LoadTasksCallback) {
    ...
    val responseHandler = { callback.onTasksLoaded(TASKS_SERVICE_DATA.values.toList()) }
    Handler().postDelayed(responseHandler, SERVICE_LATENCY_IN_MILLIS)
  }
  ...
  override fun clearCompletedTasks() {
    TASKS_SERVICE_DATA.iterator().removeIf { it.value.completed }
  }
